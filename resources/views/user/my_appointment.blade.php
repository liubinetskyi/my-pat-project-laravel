    ...
    <div align="center" style="padding:70px">
        <table class="table table-striped table-bordered">
            ...
            <tr>
                ...
                <th style="padding: 20px; width:11%">Cancel Appointment</th>
            </tr>
            </thead>
            ...
            <tr>
                ...
                <td align="center"><a class="btn btn-danger" onclick="return confirm('Are you shure to delete this?')" href="{{url('cancel_appoint', $appoints->id)}}">Cancel</a></td>
            </tr>
            </tbody>
            @endforeach
        </table>
